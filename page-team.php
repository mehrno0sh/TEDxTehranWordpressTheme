    ...
    <div class="container">
        ...
        <div class="row grid-progects" style="position: relative; height: 802px;">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 team-item team_technology">
                <div class="item-project item-team">
                    <div class="cover">
                        <div class="fit"><img class="img-cover" src="<?php bloginfo('template_directory'); ?>/img/team-2.jpg" alt="John Newman"></div>
                        <ul class="list-unstyled list-inline social-team">
                            <li><a href="about.html#demo"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 team-item team_technology">
                <div class="item-project item-team">
                    <div class="cover">
                        <div class="fit"><img class="img-cover" src="<?php bloginfo('template_directory'); ?>/img/team-3.jpg" alt="John Newman"></div>
                        <ul class="list-unstyled list-inline social-team">
                            <li><a href="about.html#demo"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
            ...
            <!-- /Item Person -->
            <!-- Item Person -->
            <div class="col-sm-6 col-md-4 col-lg-3 team-item team_technology team_core">
                <div class="item-project item-team">
                    <div class="cover">
                        <div class="fit"><img class="img-cover" src="<?php bloginfo('template_directory'); ?>/img/team-4.jpg" alt="John Newman"></div>
                        <ul class="list-unstyled list-inline social-team">
                            <li><a href="about.html#demo"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
            ...
            <!-- /Item Person -->
            <!-- Item Person -->
            <div class="col-sm-6 col-md-4 col-lg-3 team-item team_media">
                <div class="item-project item-team">
                    <div class="cover">
                        <div class="fit"><img class="img-cover" src="<?php bloginfo('template_directory'); ?>/img/team-5.jpg" alt="John Newman"></div>
                        <ul class="list-unstyled list-inline social-team">
                            <li><a href="about.html#demo"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 team-item team_technology">
                <div class="item-project item-team">
                    <div class="cover">
                        <div class="fit"><img class="img-cover" src="<?php bloginfo('template_directory'); ?>/img/team-6.jpg" alt="John Newman"></div>
                        <ul class="list-unstyled list-inline social-team">
                            <li><a href="about.html#demo"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="about.html#demo"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 team-item team_technology">
                <div class="item-project item-team">
                    <div class="cover">
                        <div class="fit"><img class="img-cover" src="<?php bloginfo('template_directory'); ?>/img/noavatar.gif" alt="Avatar"></div>
                    </div>
                    <div class="caption">
                        <h3><a target="_blank" href="volunteer.html">Join the Team!</a></h3>
                        <p class="details text-uppercase">Apply For This Role</p>
                    </div>
                </div>
            </div>
            <!-- /Item Person -->
