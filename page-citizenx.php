...
<div class="container">
<div class="row">
  <div class="col-md-12"> <img class="img-responsive c-illustration" src="<?php bloginfo('template_directory'); ?>/img/illustration-tehran.svg" alt="Rocket" data-top="position:relative; top[swing]:0px" data-top-bottom="position:relative; top[swing]:-100px" data-anchor-target=".main-slider">
      ...
      <div class="col-md-12"> 
        ...
        <div class="item-review">
          ...
          <div class="item-review">
            <div class="row">
              <div class="col-md-12">
                <div class="user-image"> <img src="<?php bloginfo('template_directory'); ?>/img/Citizenx/user-image-2.jpg" alt="Sweepers in Our City"> </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="user-image"> <img src="<?php bloginfo('template_directory'); ?>/img/Citizenx/user-image-1.jpg" alt="Gholamali Soleimani"> </div>
              <div class="text-reviews"> <span class="icon-quote"></span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit facere, molestias a qui itaque facilis dicta sequi, in eius unde quasi minima nulla voluptates dolores autem sapiente sunt eos earum, culpa? Dignissimos corporis iure vero beatae in, eius, ipsum maiores maxime repellat deleniti rem?</p>
