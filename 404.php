	...
	<div class="container-error vertical-center">
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<a id="btn-404" class="btn btn-red animated bounceInUp" href="/">Back Homepage</a>
			</div>			
		</div>
	</div>
